  ...
  render() {
    return (
      ...
      centerComponent={
        ...
        <Icon0 
        onPress={() => (this.state.role === 'Father' || this.state.role === 'Mother' ? 
        this.props.navigation.navigate('User Information') : null)} 
        name={userRole[this.state.role]} size={35} color="red" 
        />
        <Text 
        onPress={() => (this.state.role === 'Father' || this.state.role === 'Mother' ? 
        this.props.navigation.navigate('User Information') : null)} 
        ...
        {this.state.role}
               ...
               <View style={styles.centerComponent}>
                ...
                <View style={styles.centerComponent}>
                  ...
                  style={styles.textIconMoney}>{this.state.restMoney}
                  </Text>
                  <Text 
                  onPress={() =>this.props.navigation.navigate('Finance')} 
                  style={styles.textUnderIcon}>
              ...
              */}
              ...
              <Icon6
              onPress={() => (this.state.role === 'Father' || this.state.role === 'Mother' ? 
                this.props.navigation.navigate('Task Monitor') : 
                this.props.navigation.navigate('TasksDisplay'))} 
              style={{ color: '#0bf5fb' }} 
            ...
            rightComponent={
              ...
              <Icon8
              onPress={() => this.props.navigation.navigate('Login')} style={{ color: '#0bf5fb' }} 
              name="logout" size={35}
              />
              <Text 
